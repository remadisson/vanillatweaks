...
public class TeleportRequester implements CommandExecutor, TabExecutor {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        TeleportType type = TeleportType.THERE;
        ...
        TextComponent targetComponent = Component.text(Messages.getPrefix() + "§2" + player.getName() + "§a will sich zu dir teleportieren. ");
    ...
    public @Nullable List<String> onTabComplete(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        for (Player online : Bukkit.getOnlinePlayers()) {
            if (!TeleporterManager.contains(player.getUniqueId(), online.getUniqueId(), TeleportType.THERE)) {
